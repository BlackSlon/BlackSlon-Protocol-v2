...
import Link from 'next/link'; // Import nawigacji
  ...
  return (
    <main style={{ backgroundColor: '#000', minHeight: '100vh', color: '#fff', fontFamily: 'monospace' }}>
      ...
      <div style={{ 
        ...
        {/* SIATKA 5 KWADRATÓW - MAŁE, OSTRE ROGI */}
        <div style={{ 
          display: 'flex', 
          justifyContent: 'center',
          gap: '15px', 
          ...
          {/* ŻÓŁTY PRZYCISK - TERAZ JAKO LINK DO TERMINALA */}
          <Link href="/terminal" style={{ textDecoration: 'none' }}>
            <div style={{ ...squareStyle('#FFD700', '#000') }}>
