  ...
  return (
    <div className="flex flex-col h-full bg-black font-mono text-white p-0">
      ...
      <div className="flex-grow px-6 pb-6 flex flex-col min-h-0 sm:px-2">
        <div className="pl-4 pr-4 pt-4 pb-2 bg-gradient-to-b from-black to-gray-950 w-full sm:pl-4 sm:pr-4 sm:pt-4 sm:pb-2">
          ...
          <div className="text-[10px] tracking-widest text-amber-700 font-bold mb-0.5 mt-2">BlackSlon Tokens Portfolio</div>
        </div>
