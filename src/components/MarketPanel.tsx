  ...
  return (
    <div className="flex flex-col h-full p-4 select-none" style={montserratStyle}>
      ...
      <div className="mb-4">
        ...
        <div className="text-center mb-1">
          <span className="text-[10px] text-red-600 font-bold tracking-widest uppercase">VIRTUAL DIMENSION</span>
        </div>
        ...
        <div className="bg-gray-950/40 rounded-sm border border-gray-900 p-3">
          ...
          <div className="flex justify-between mt-3 px-2">
            ...
            <div className="text-center">
              ...
              <div className="text-[8px] text-green-500 font-mono mt-1">+2.34</div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="text-[8px] text-red-500 font-mono mt-1">-1.87</div>
            </div>
          </div>
