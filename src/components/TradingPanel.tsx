  ...
  return (
    <div className="flex flex-col h-full p-2 select-none font-sans bg-transparent scale-[0.85] origin-top overflow-hidden">
      ...
      <div className="text-left mb-2 shrink-0">
        <div className="text-[8px] text-gray-600 uppercase font-bold mb-0.5">Active Instrument</div>
      ...
      {/* EXECUTE - Mniejszy przycisk */}
      <button className={`w-full py-1.5 mb-3 border font-black uppercase tracking-[0.3em] text-[10px] transition-all duration-300 rounded-sm shrink-0
        ${side === 'BUY' 
