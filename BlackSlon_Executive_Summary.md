**Version:** 3.0 | **Status:** Pre-Launch | **Date:** March 2026 | **Classification:** Public
...
**Universal Access. Perpetual Instruments** - BlackSlon reduces the minimum entry threshold by four orders of magnitude. Instead of €744,600 for the smallest German yearly power contract (1 MW Baseload × 8,760 hours × €85/MWh), participation begins at **100 kWh** — a few euros. The same market, accessible to any participant, anywhere, at any time. And once you enter — there is no forced roll, no year-end liquidity crunch, no expiry mechanics. A position opened today remains valid indefinitely, continuously anchored to physical market reality. No extra cost (maintanance fees, overnight funding fees, currency conversion fees).

**BlackSlon Settlement Zone (BSSZ)** — A physically-anchored price corridor [A−10%, A+20%] derived from a weighted forward curve (10% Spot / 40% Front Month / 25% Front Quarter / 25% Calendar Year). It filters volatility noise while preserving directional signal. During the Iran '26 shock: TTF moved +114.8% — the BSSZ Anchor tracked **+55% over the same 8 days**, with a maximum single-day move of +19%, zero transmission of the -19.5% crash. **The trend was captured. The chaos was not.**

**The Democratisation of the Forward Curve** — European energy markets are structurally backwardated. Cal+1 and Cal+2 contracts trade at a significant discount to spot — but accessing them requires investment-grade credit ratings and hundreds of thousands in posted guarantees held idle for 12–24 months. When you buy 100 kWh of BS-G-NL for a few euros, you are buying a utility token that already contains the structural discount of the forward curve — the same economic advantage that Goldman Sachs and Shell extract through multi-million euro positions — accessible without a credit rating, without a bank guarantee, and without a six-month onboarding process. **For the first time, the cheapest part of the energy market is also the most accessible.**
